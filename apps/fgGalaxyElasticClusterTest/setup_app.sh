...
#
APPNAME="fgGalaxyElasticClusterTest"
APPDESC="hostname tester application on fgGalaxy with cluster support for tests"
OUTCOME="JOB"
TOSCA_ENDPOINT="http://paas-orchestrator.cloud.ba.infn.it:8080/deployments"
TOSCA_IP="paas-orchestrator.cloud.ba.infn.it"
INFRADESC="Tosca test at $TOSCA_ENDPOINT"
INFRANAME="tosca_Test@$TOSCA_IP"
FILESPATH="$FGLOCATION/fgAPIServer/apps/fgGalaxyElasticClusterTest"
TOKEN=$1
if [ "$TOKEN" != "" ]; then
